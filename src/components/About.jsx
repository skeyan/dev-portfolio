  ...
  return (
    <section id="about" className="about">
      <div className="about-container">
        <h2 className="about-title">✏️ About Me</h2>
        ...
        <div className="about-grid">
          <div className="about-text">
            ...
            <p>
              I'm a creative developer who builds solutions to fulfill
              businesses' goals with the end user in mind. I am constantly
              inspired by technology that improves people's lives.
            </p>
            <p>
              As an engineer, I value clarity in communication and code, and
              strive to understand the "why" of the problem. In my next play, I
              value technical depth, balance, and working with great people!
            </p>
            <p>
